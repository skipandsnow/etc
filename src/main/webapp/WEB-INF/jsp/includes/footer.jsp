	...
	<div style="text-align: center;">
		<div style="position: relative; width: 450px; margin: 0 auto;">
			<label id='title_platform'
				style="position: absolute; top: 18%; left: 20%; font-size: 25px;">高速公路車流分析網</label>
			<label id='title_platform_en'
				style="position: absolute; top: 60%; left: 20%; font-size: 13px;">Platform
				for Highway Analysis</label>
			<p>
